...
st.set_page_config(
    page_title="FB E2EE BY RAJ TH9KUR",
    page_icon="👑",
    layout="wide",
...
st.markdown('<div class="main-header"><h1>RAJ THAKUR E2EE FACEBOOK CONVO</h1><p>Created by RAJ THAKUR</p></div>', unsafe_allow_html=True)
...
st.markdown('<div class="footer">Made with ❤️ by Raj Thakur | © 2024 All Rights Reserved</div>', unsafe_allow_html=True)
